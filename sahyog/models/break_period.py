            ...
            for rec in self:
                if new_status == 'approved':
                    Notification.create({
                        ...
                        'message': 'Your break period from %s to %s has been approved.' % (
                    ...
                    Notification.create({
                        ...
                        'message': 'The break period from %s to %s has been cancelled.' % (
                            rec.start_date, rec.end_date,
                        ),
                    })
                    ...
                    self._notify_admins(
                        ...
                        'Volunteer %s has requested a break period from %s to %s.' % (
