...
/** Top-of-screen PWA install prompt (Android: native prompt; iOS: add-to-
 *  home-screen hint). Mirrors the sahyog/app banner. */
      ...
      <Group justify="space-between" align="center" wrap="nowrap">
        <Group gap={8} align="center" wrap="nowrap" style={{ flex: 1, minWidth: 0 }}>
          ...
          {isIos ? (
            ...
            <Text size="sm" c="white" truncate>
              Install Vaani for quick access
            </Text>
          )}
        </Group>
        <Group gap={6} wrap="nowrap" style={{ flexShrink: 0 }}>
          {!isIos && (
            <Button size="compact-sm" variant="white" color="clay" onClick={install}>
              Install
            </Button>
          )}
          <CloseButton
